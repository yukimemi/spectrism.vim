---
name: randomcolorscheme
description: A random colorscheme plugin.
---

=pod

=head1 dps-randomcolorscheme

Denops random colorscheme.

=head1 Features X<randomcolorscheme-features>

This plugin change the colorscheme for Vim / Neovim.

=head1 Installation X<randomcolorscheme-installation>
...
=head1 Requirements X<randomcolorscheme-requirements>
...
=head1 Usage X<randomcolorscheme-usage>

No special settings are required.
By default it changes the colorscheme every 3,600 seconds.

=head1 Commands X<randomcolorscheme-commands>

C<:ChangeColorscheme>                                      X<:ChangeColorscheme>
Change the colorscheme.

C<:OpenColorschemeSetting>                            X<:OpenColorschemeSetting>
...
C<:ResetColorschemeSetting>                          X<:ResetColorschemeSetting>
...
C<:DisableRandomColorscheme>                        X<:DisableRandomColorscheme>
Disable randomcolorscheme.
Stop changing colorschme.

C<:EnableRandomColorscheme>                          X<:EnableRandomColorscheme>
Enable randomcolorscheme.

C<:DisableThisColorscheme>                            X<:DisableThisColorscheme>
Disable this colorscheme.
(Set colorschmeme priority to 0.)

C<:LikeThisColorscheme [size]>                           X<:LikeThisColorscheme>
Increase priority by `g:randomcolorscheme_changesize`. (default)
If size is passed, increase priority according to size.

C<:HateThisColorscheme [size]>                           X<:HateThisColorscheme>
Decrease priority by `g:randomcolorscheme_changesize`. (default)
If size is passed, decrease priority according to size.

=head1 Config X<randomcolorscheme-config>

No settings are required. However, the following settings can be made if necessary.

C<g:randomcolorscheme_debug>                        X<g:randomcolorscheme_debug>
Enable debug messages.
default is v:false

C<g:randomcolorscheme_echo>                          X<g:randomcolorscheme_echo>
Whether to echo the modified colorscheme.
default is v:true

C<g:randomcolorscheme_notify>                      X<g:randomcolorscheme_notify>
Whether to `vim.notify` the modified colorscheme. (Neovim only)
default is v:false

C<g:randomcolorscheme_interval>                  X<g:randomcolorscheme_interval>
Interval to change colorscheme.
default is 3600 (seconds)

C<g:randomcolorscheme_retry>                        X<g:randomcolorscheme_retry>
Whether to retry change colorscheme when after changed colorschme is same before.
default is v:true

C<g:randomcolorscheme_checkwait>                X<g:randomcolorscheme_checkwait>
...
C<g:randomcolorscheme_enables>                    X<g:randomcolorscheme_enables>
...
C<g:randomcolorscheme_disables>                  X<g:randomcolorscheme_disables>
...
C<g:randomcolorscheme_match>                        X<g:randomcolorscheme_match>
...
C<g:randomcolorscheme_notmatch>                  X<g:randomcolorscheme_notmatch>
...
C<g:randomcolorscheme_priority>                  X<g:randomcolorscheme_priority>
The priority of the colorscheme. (readonly)
You can use this value for statusline.

=head1 Example X<randomcolorscheme-example>
...
=head1 License X<randomcolorscheme-license>
