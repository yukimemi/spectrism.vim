...
=head1 Denops randomcolorscheme *randomcolorscheme*

Denops random colorscheme.

=head2 Features *randomcolorscheme-features*

This plugin change the colorscheme for Vim / Neovim.

=head2 Installation *randomcolorscheme-installation*
...
=head2 Requirements *randomcolorscheme-requirements*
...
=head2 Usage *randomcolorscheme-usage*

No special settings are required.
By default it changes the colorscheme every 3,600 seconds.

=head2 Commands *randomcolorscheme-commands*
...
=head2 Config *randomcolorscheme-config*
...
=head2 Example *randomcolorscheme-example*
...
=head2 License *randomcolorscheme-license*
