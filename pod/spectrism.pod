...
=head1 Features X<spectrism-features>

This plugin change the colorscheme for Vim / Neovim.

=head1 Installation X<spectrism-installation>
...
=head1 Requirements X<spectrism-requirements>
...
=head1 Usage X<spectrism-usage>

No special settings are required.
By default it changes the colorscheme every 3,600 seconds.

=head1 Commands X<spectrism-commands>
...
C<:DisableSpectrism>                        X<:DisableSpectrism>
Disable spectrism.
Stop changing colorschme.

C<:EnableSpectrism>                          X<:EnableSpectrism>
Enable spectrism.
...
=head1 Config X<spectrism-config>

No settings are required. However, the following settings can be made if necessary.

C<g:spectrism_debug>                        X<g:spectrism_debug>
Enable debug messages.
default is v:false

C<g:spectrism_echo>                          X<g:spectrism_echo>
Whether to echo the modified colorscheme.
default is v:true

C<g:spectrism_notify>                      X<g:spectrism_notify>
Whether to `vim.notify` the modified colorscheme. (Neovim only)
default is v:false

C<g:spectrism_interval>                  X<g:spectrism_interval>
Interval to change colorscheme.
default is 3600 (seconds)

C<g:spectrism_retry>                        X<g:spectrism_retry>
Whether to retry change colorscheme when after changed colorschme is same before.
default is v:true

C<g:spectrism_checkwait>                X<g:spectrism_checkwait>
...
C<g:spectrism_enables>                    X<g:spectrism_enables>
...
C<g:spectrism_disables>                  X<g:spectrism_disables>
...
C<g:spectrism_match>                        X<g:spectrism_match>
...
C<g:spectrism_notmatch>                  X<g:spectrism_notmatch>
...
C<g:spectrism_priority>                  X<g:spectrism_priority>
The priority of the colorscheme. (readonly)
You can use this value for statusline.

=head1 Example X<spectrism-example>
...
=head1 License X<spectrism-license>
